...
--
-- Host: 172.17.0.3    Database: openfire
-- ------------------------------------------------------
...
INSERT INTO `ofID` VALUES (18,1),(19,1),(23,1),(25,6),(26,2);
...
INSERT INTO `ofProperty` VALUES ('httpbind.CORS.domains','*'),('httpbind.CORS.enabled','true'),('httpbind.enabled','true'),('httpbind.forwarded.enabled','false'),('httpbind.port.plain','5280'),('provider.admin.className','org.jivesoftware.openfire.admin.DefaultAdminProvider'),('provider.auth.className','org.jivesoftware.openfire.auth.DefaultAuthProvider'),('provider.group.className','org.jivesoftware.openfire.group.DefaultGroupProvider'),('provider.lockout.className','org.jivesoftware.openfire.lockout.DefaultLockOutProvider'),('provider.securityAudit.className','org.jivesoftware.openfire.security.DefaultSecurityAuditProvider'),('provider.user.className','org.jivesoftware.openfire.user.DefaultUserProvider'),('provider.vcard.className','org.jivesoftware.openfire.vcard.DefaultVCardProvider'),('update.lastCheck','1418132398605'),('xmpp.auth.anonymous','true'),('xmpp.component.defaultSecret','secret'),('xmpp.component.socket.active','true'),('xmpp.domain','jvmeet.sipfoundry.org'),('xmpp.session.conflict-limit','0'),('xmpp.socket.ssl.active','true');
...
INSERT INTO `ofPubsubAffiliation` VALUES ('pubsub','','jvmeet.sipfoundry.org','owner');
...
INSERT INTO `ofPubsubNode` VALUES ('pubsub','',0,'001418132362124','001418132362124',NULL,0,0,0,0,1,1,1,0,0,'publishers',1,0,'open','','','','jvmeet.sipfoundry.org','','English','',NULL,'all',-1);
...
INSERT INTO `ofSecurityAuditLog` VALUES (1,'admin',1418133509716,'disabled external component service','e177c7e8f4a0',NULL),(2,'admin',1418134008467,'enabled external component service on port 5275','7846f4671ee2',NULL),(3,'admin',1418134990497,'updated HTTP bind settings','7846f4671ee2',NULL),(4,'admin',1418135373672,'updated HTTP bind settings','7846f4671ee2',NULL),(5,'admin',1418135412797,'updated HTTP bind settings','7846f4671ee2',NULL);
...
-- Dump completed on 2014-12-09 10:57:29
